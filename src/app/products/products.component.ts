...
export class ProductsComponent implements OnInit {
  ...
  getProductImages(productName: string) {
    ...
    this.productInfo = {
      ...
      description: (productName == 'shampoo') ? `Sesa Ayurvedic Shampoo is an ayurvedic blend of 17 botanicals like Bhringraj, triphala, mehandi,
        jati and yashtimadhu which cleanses and maintains the integrity of scalp and hair. It is the perfect solution for optimum hair nourishment and complete
        care.` : `Sesa Ayurvedic is a distinctive combination of 18 nourishing herbs, 5 nourishing oils and milk all boiled together in
          a special process called the 'Kshirpak Vidhi'. It consists of natural ingredients like Rasot, Neem beej, Chamelee, Tagar, Khas, Elva, essential oils
            and Karan Beej. These natural and ayurvedic ingredients helps prevent infection, mental stress, dandruff & lice.`,
